...
omega = 1.5
eps = np.sqrt(10)
betas = np.linspace(1,10,N_betas)
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N2[i,j] = E(2,betas[i], omega, eps, t[j])
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N3[i,j] = E(3,betas[i], omega, eps, t[j])
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N4[i,j] = E(4,betas[i], omega, eps, t[j])
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N5[i,j] = E(5,betas[i], omega, eps, t[j])
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N6[i,j] = E(6,betas[i], omega, eps, t[j])
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N7[i,j] = E(7,betas[i], omega, eps, t[j])
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N8[i,j] = E(8,betas[i], omega, eps, t[j])
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N9[i,j] = E(9,betas[i], omega, eps, t[j])
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N10[i,j] = E(10,betas[i], omega, eps, t[j])
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N11[i,j] = E(11,betas[i], omega, eps, t[j])
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N12[i,j] = E(12,betas[i], omega, eps, t[j])
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N13[i,j] = E(13,betas[i], omega, eps, t[j])
...
for i in range(N_betas):
    for j in range(Nt):
        Energy_N14[i,j] = E(14,betas[i], omega, eps, t[j])
...
plt.figure()
plt.plot(betas*1.5, Gamma_N2, 'C0',linewidth = 2, label = r'$N=2$')
plt.plot(betas*1.5, Gamma_N3, 'C3',linewidth = 2, label = r'$N=3$')
plt.plot(betas*1.5, Gamma_N4, 'C7',linewidth = 2, label = r'$N=4$')
plt.plot(betas*1.5, Gamma_N5, 'k',linewidth = 2, label = r'$N=5$')
plt.ylabel(r'$\Gamma$', fontsize = 14)
plt.xlabel(r'$\beta\omega$', fontsize = 14)
plt.legend()
